									...
									if ( $current_post_index % 3 === 0 ) :
										...
										<div class="card mb-3 mx-0 mx-sm-5 mx-md-1 rounded-0">
											...
											<div class="card-body pb-0">
												<h5 class="card-title mb-0"><?php echo $title; ?><small class="card-text text-muted mb-0">&nbsp;&#8212;&nbsp;<?php echo $description; ?></small></h5>
												<p class="card-text mb-3"><small class="text-muted"><?php echo $year; ?>&nbsp;&#8212;&nbsp;<?php echo $label; ?></small>
												</p>
												<ul class="list-group list-group-flush">
													<li class="list-group-item">
														<iframe style="border: 0; width: 100%; height: 42px;" src="https://bandcamp.com/EmbeddedPlayer/<?php echo $bandcamp_id_type; ?>=<?php echo $bandcamp_track_id; ?>/size=small/bgcol=ffffff/linkcol=177e89/artwork=none/transparent=true/" seamless><a href="<?php echo $bandcamp; ?>"><?php echo $title; ?></a></iframe>
													</li>
												</ul>
											</div>
										</div>
			...
			<div class="row justify-content-center d-lg-none">
				...
				<div class="col-12">
					...
					<div class="w-100 d-flex justify-content-center">
						<button class="btn btn-white my-3 text-uppercase" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAlbums" aria-expanded="false" aria-controls="collapseAlbums">
							&darr; more
						</button>
					</div>
