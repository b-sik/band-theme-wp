...
<header id="header" class="vh-100 d-flex flex-column position-relative">
	...
	<div id="hero-content-overlay" class="container-fluid min-vh-100 w-100 position-absolute px-2" style="z-index:1033;">
		<div class="col-12 min-vh-100 w-100 d-flex flex-column justify-content-end text-center text-lg-start px-0">
			<div style="color: #fff;text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;">
